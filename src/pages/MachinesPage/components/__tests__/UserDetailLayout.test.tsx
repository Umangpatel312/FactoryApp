...
import MachineDetailLayout from '../MachineDetailLayout';
...
describe('UserDetailLayout', () => {
  ...
  it('should use custom testId', async () => {
    // ARRANGE
    render(<MachineDetailLayout testId="custom-testId" />);
  ...
  it('should custom className', async () => {
    // ARRANGE
    render(<MachineDetailLayout className="custom-className" />);
    await screen.findByTestId('layout-user-detail');
