...
// import * as UseGetUsers from '../../api/useGetMachines';
...
describe('UserList', () => {
  ...
  it('should use custom testId', async () => {
    // ARRANGE
    render(<AttendenceList testId="custom-testId" />);
  ...
  it('should use custom className', async () => {
    // ARRANGE
    render(<AttendenceList className="custom-className" />);
    await screen.findByTestId('list-users');
