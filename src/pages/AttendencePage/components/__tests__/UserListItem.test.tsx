...
describe('UserListItem', () => {
  it('should render successfully', async () => {
    // ARRANGE
    render(<MachineListItem user={userFixture1} />);
  ...
  it('should use custom testId', async () => {
    // ARRANGE
    render(<MachineListItem user={userFixture1} testId="custom-testId" />);
  ...
  it('should use custom className', async () => {
    // ARRANGE
    render(<MachineListItem user={userFixture1} className="custom-className" />);
    await screen.findByTestId('list-item-user');
  ...
  it('should use active styles', async () => {
    // ARRANGE
    render(<MachineListItem user={userFixture1} isActive />);
    await screen.findByTestId('list-item-user');
