...
describe('UserListItem', () => {
  it('should render successfully', async () => {
    // ARRANGE
    render(<EmployeeListItem employee={userFixture1} />);
  ...
  it('should use custom testId', async () => {
    // ARRANGE
    render(<EmployeeListItem employee={userFixture1} testId="custom-testId" />);
  ...
  it('should use custom className', async () => {
    // ARRANGE
    render(<EmployeeListItem employee={userFixture1} className="custom-className" />);
    await screen.findByTestId('list-item-user');
  ...
  it('should use active styles', async () => {
    // ARRANGE
    render(<EmployeeListItem employee={userFixture1} isActive />);
    await screen.findByTestId('list-item-user');
